...
- **More than 5 branch points per template.** Multipass caps at 32 combinations to bound validation work. Surplus branch points fall back to the single-branch heuristic; branches you might want validated may be skipped. In practice, deeply branching templates are rare; refactoring into smaller components is usually cleaner anyway.
